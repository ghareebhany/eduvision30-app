...
class _RedeemCodeScreenState extends ConsumerState<RedeemCodeScreen> {
  ...
  /// بعد نجاح الكود: حدّث الحالة محلياً فوراً ثم أعد تحميل الشاشات من الخادم
  void _onSuccess(Map<String, dynamic> result) {
    ...
    // تحديث شاشات الدورات بعد استخدام الكود بنجاح:
    // 1) امسح الكاش المحلي للكورسات/الدروس/المواضيع
    CacheManager.instance.invalidateCourseData();
    // 2) أعد تحميل "دوراتي" + لوحة التحكم + الحزم من الخادم
                ...
                Container(
                  ...
                  child: Row(children: [
                    Container(
                      width: 40, height: 40,
                      decoration: BoxDecoration(
                        color: AppTheme.coral500.withValues(alpha: 0.14),
                      ...
                      child: Icon(
                        ...
                        color: AppTheme.coral500, size: 20,
                      ),
                    ),
...
class _InputCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final surf = AppPalette.surface(context);
    final line = AppPalette.border(context);
    final fieldBg = AppPalette.surfaceAlt(context);
    return Container(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(
              ...
              size: 32, color: AppTheme.coral500,
            ),
          ),
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 13, color: AppPalette.textSecondary(context), height: 1.5),
          ),
          const SizedBox(height: 24),
          ...
          TextField(
            ...
            style: TextStyle(
              ...
              letterSpacing: 4, color: AppPalette.textPrimary(context),
            ),
            inputFormatters: [
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color: error != null ? AppTheme.error : line,
                ),
              ),
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide: BorderSide(
                  color: error != null ? AppTheme.error : AppTheme.coral500,
                  width: 1.5,
                ),
              ),
                ...
                children: [
                  Row(children: [
                    Icon(Icons.library_books_rounded,
                        size: 15, color: AppTheme.coral500),
