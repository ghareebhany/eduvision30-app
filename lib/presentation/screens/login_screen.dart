...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  void initState() {
    super.initState();
    // Fix: نداء إمبراتيفي كان يضارب مع الضبط التفاعلي في main.dart —
    // استُبدل بـ AnnotatedRegion في build() (شاشة الدخول غامقة دائماً
    // بتصميمها بغضّ النظر عن ثيم التطبيق، فده ثابت وصحيح هنا فقط).
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          // Fix: mocha800 كانت شبه مطابقة لخلفية الشاشة (mocha900)
                          // فالكارت العلوي كان يندمج بلا حدود واضحة
                          color: AppTheme.mocha700.withValues(alpha: 0.95),
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Username (يدعم: البريد / اسم المستخدم / رقم الهاتف)
                              _FieldLabel(
                                  label:
                              ...
                              _DarkField(
                                ...
                                hint: 'بريدك أو اسم المستخدم أو رقم هاتفك',
                              ...
                              // ملاحظة توضيحية: النظام يقبل الدخول بأي من الثلاثة
                              const SizedBox(height: 8),
                              Row(
                                children: [
                                  Icon(
                                  ...
                                  Expanded(
                                    child: Text(
                                      'يمكنك الدخول بالبريد الإلكتروني أو اسم المستخدم أو رقم الهاتف المسجّل',
                                      style: TextStyle(
                                        fontSize: 11.5,
                                        height: 1.4,
                                        color: Colors.white
...
class _DarkField extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TextFormField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          // Fix: 7%/12% أبيض كانت شبه غير مرئية فوق الخلفية الغامقة
