  ...
  Widget build(BuildContext context) {
    final cards = <_FeatureCardData>[
      _FeatureCardData(
        ...
        route: '/hub/quizzes',
        colors: const [Color(0xFF23AB96), Color(0xFF157C86)], // تركوازي
      ),
      _FeatureCardData(
        ...
        route: '/hub/qna',
        colors: const [Color(0xFF026ECD), Color(0xFF0E3B85)], // أزرق نيلي
      ),
      _FeatureCardData(
        ...
        colors: const [Color(0xFF23AB96), Color(0xFF157C86)], // زمردي
      ),
      _FeatureCardData(
        ...
        route: '/hub/reviews',
        colors: const [Color(0xFFF87625), Color(0xFFDC642B)],
      ),
    ];
