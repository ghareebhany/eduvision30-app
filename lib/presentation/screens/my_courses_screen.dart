...
class _CoursesListState extends ConsumerState<_CoursesList> {
  ...
  Widget build(BuildContext context) {
    ...
    return async.when(
      loading: () => const _MyCoursesSkeleton(),
        ...
        return RefreshIndicator(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (_, i) => _FadeSlideIn(
              index: i,
              child: _MyCourseCard(item: items[i]),
            ),
          ),
        );
      },
...
class _MyCoursesSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      baseColor: AppPalette.surfaceAlt(context),
      highlightColor: AppPalette.surface(context),
      child: ListView.separated(
        padding: const EdgeInsets.fromLTRB(16, 20, 16, 100),
        itemCount: 4,
        separatorBuilder: (_, __) => const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        // دائمًا إلى شاشة التفاصيل ذات التبويبات (المحتوى/التقييمات/الأسئلة/الواجبات)
                      ...
                      child: Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          const Icon(Icons.star_rounded,
                              size: 12, color: Color(0xFFF87625)),
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: isCompleted
                  ? [AppPalette.successGreen, const Color(0xFF026ECD)]
