...
class AppTheme {
  ...
  static const Color mocha900     = Color(0xFF001130); // أعمق — splash bg
  ...
  static const Color mocha850     = Color(0xFF143968); // بطاقات/أسطح مرفوعة (dark)
  static const Color mocha800     = Color(0xFF001B41); // scaffold (dark)
  static const Color mocha700     = Color(0xFF1D4884); // أسطح أعلى (chips/surfaceAlt) + هيدر السبلاش/تسجيل الدخول
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          elevation: 3,
          shadowColor: coralLight500.withValues(alpha: 0.40),
        ),
      ),
