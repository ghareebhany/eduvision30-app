...
abstract class AppPalette {
  ...
  static const LinearGradient btnGradient = LinearGradient(
    ...
    colors: [AppTheme.coral500, AppTheme.coral600],
  );

  static const LinearGradient btnGradientLight = LinearGradient(
    begin: Alignment.centerLeft,
    end:   Alignment.centerRight,
    colors: [AppTheme.coralLight500, AppTheme.coralLight600],
  );
